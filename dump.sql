...
CREATE TABLE public.flights (
    ...
    destination integer,
    date date,
    CONSTRAINT flights_destination_check CHECK ((destination > 0)),
    CONSTRAINT flights_origin_check CHECK ((origin > 0))
);
...
INSERT INTO public.cities VALUES (8, 'Belo Horizonte');
...
INSERT INTO public.passengers VALUES (1, 'Lucas', 'Soares');
